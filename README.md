...
1. Start the 5 Slave servers (each with their own IP and port).
2. Start the Master server, configured with the Slave nodes’ IPs and IDs.
3. Use `kvClient` to send `put` and `get` commands to the Master.
